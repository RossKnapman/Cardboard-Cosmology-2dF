...
public class AddGalaxies : MonoBehaviour {
	...
	static float alphaValue = 0.8f; // The red value of each particle, on a scale from 0 to 1
	...
	void Start () {
		...
		file = Resources.Load<TextAsset> ("2dFProcessed"); // Load galaxies from text file
